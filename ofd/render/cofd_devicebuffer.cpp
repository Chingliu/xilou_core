...
#include "ofd/render/cofd_devicebuffer.h"
...
// static
CFX_Matrix COFD_DeviceBuffer::CalculateMatrix(CFX_RenderDevice* pDevice,
                                              const FX_RECT& rect,
                                              int max_dpi,
                                              bool scale) {
  CFX_Matrix matrix;
...
COFD_DeviceBuffer::COFD_DeviceBuffer(COFD_RenderContext* pContext,
...
COFD_DeviceBuffer::~COFD_DeviceBuffer() = default;

bool COFD_DeviceBuffer::Initialize() {
  FX_RECT bitmap_rect =
...
void COFD_DeviceBuffer::OutputToDevice() {
