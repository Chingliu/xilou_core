...
class CFX_XMLElement final : public CFX_XMLNode {
 public:
  ...
  CFX_XMLElement* GetFirstChildNamed_NoPrefix(WideStringView name) const;
  CFX_XMLElement* GetNthChildNamed_NoPrefix(WideStringView name,
                                            size_t idx) const;

  CFX_XMLElement* GetNextSiblingNamed_NoPrefix(WideStringView name);
